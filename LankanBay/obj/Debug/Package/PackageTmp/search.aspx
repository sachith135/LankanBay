<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/sitemaster.Master" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="LankanBay.search" %>
                   ...
                   <%
                       ...
                       if (!IsPostBack)
                       {
                           ...
                           if (Request.QueryString.Count > 0 && Request.QueryString != null)
                           {
                               ...
                               itemDetails.SearchKeyWord = Request.QueryString[0].ToString();
