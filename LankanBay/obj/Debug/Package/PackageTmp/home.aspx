<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/sitemaster.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="LankanBay.home" %>
...
<hr class="separator" style="margin-top:10px;"/>
                   ...
                   <%
                       ...
                       if (!IsPostBack)
                       {
                           ...
                           int itemRowIndex = 0;
                           dtItemDetails = itemDetailsService.SelectItemDetailsForMainPage();
